...
export const mockSuppliers: Supplier[] = [
  {
    ...
    whatsapp_device_ids: null,
    telegram_device_ids: null,
    balance: 50000.00,
  ...
  },
  {
    ...
    system_id: 'NET2APP',
    smpp_version: 'auto', smpp_system_type: '', smpp_bind_type: 'trx', smpp_addr_ton: 0, smpp_addr_npi: 0, smpp_addr_range: '', is_inbound: false,

    api_url: '',
    api_key: '',
    api_method: 'POST',
    api_connector_id: null, voice_otp_config_id: null, whatsapp_device_ids: null, telegram_device_ids: null,
