...
<Card title="Billing & Queue Settings"><div className="grid grid-cols-3 gap-6">
  ...
  <Input label="Auto-Block After N Failures" type="number" value={formData.max_failures} onChange={e => updateField('max_failures', parseInt(e.target.value)||0)} hint="Auto-block supplier after this many consecutive failed SMS (0 = disabled, default 20)" min={0} />
