    ...
    <div className="space-y-6">
      ...
      {activeTab==='overview'&&<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card title="Billing"><div className="space-y-3">
          ...
          <div className="flex justify-between p-3 bg-gray-50 rounded-lg"><span className="text-gray-600">Force DLR</span><Badge variant={(supplier as any).force_dlr ? 'warning' : 'default'}>{(supplier as any).force_dlr ? `Yes (${(supplier as any).force_dlr_timeout_mode || 'fixed'} / ${(supplier as any).force_dlr_timeout || 150}s)` : 'No'}</Badge></div>
        </div></Card>
