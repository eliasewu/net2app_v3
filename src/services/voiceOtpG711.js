...
const VOS_CONFIG = {
  host: process.env.VOS_HOST || '',
  port: Number(process.env.VOS_PORT || 5060),
  localIp: process.env.SIP_LOCAL_IP || '0.0.0.0',
  rtpPort: Number(process.env.SIP_RTP_PORT || 10000)
};
...
class VoiceOtpG711Service {
  ...
  init() {
    ...
    this.sipSocket.bind(Number(process.env.SIP_LOCAL_PORT || 5060));
