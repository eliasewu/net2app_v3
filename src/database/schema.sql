...
CREATE TABLE clients (
    ...
    force_dlr_timeout INTEGER DEFAULT 0,
    force_dlr_timeout_mode VARCHAR(20) DEFAULT 'random_0_5' CHECK (force_dlr_timeout_mode IN ('random_0_5','fixed','random_1_5','random_1_10')),
...
CREATE TABLE suppliers (
    ...
    portal_access BOOLEAN DEFAULT false,
    manual_disconnect BOOLEAN DEFAULT false,
    voice_otp_mode VARCHAR(50),
    max_queue_size INTEGER DEFAULT 1000,
    ott_max_tps INTEGER DEFAULT 0,
    ott_proxy_node VARCHAR(255),
    status VARCHAR(20) DEFAULT 'active' CHECK (status IN ('active','inactive','suspended')),
    is_deleted BOOLEAN DEFAULT false,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE sms_logs (
    ...
    dlr_source VARCHAR(20) DEFAULT 'REAL',
    refund_amount DECIMAL(10,6) DEFAULT 0,
    is_deleted BOOLEAN DEFAULT false,
    submit_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    delivery_time TIMESTAMP,
    message_type VARCHAR(20) DEFAULT 'otp',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE invoices (
    ...
    force_dlr_charge DECIMAL(15,4) DEFAULT 0,
...
CREATE TABLE translations (
    id SERIAL PRIMARY KEY,
    translation_type VARCHAR(50) NOT NULL CHECK (translation_type IN ('number_prefix','content_replace','otp_extract','sid_random','sid_alias','random_content','number_blacklist','keyword_blacklist','keyword_whitelist','url_block','keyword_replace')),
    ...
    otp_strict_mode BOOLEAN DEFAULT true,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
