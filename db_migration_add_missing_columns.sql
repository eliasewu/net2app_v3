...
ALTER TABLE clients ADD COLUMN IF NOT EXISTS portal_access BOOLEAN DEFAULT false;
...
ALTER TABLE suppliers ADD COLUMN IF NOT EXISTS portal_access BOOLEAN DEFAULT false;
ALTER TABLE suppliers ADD COLUMN IF NOT EXISTS manual_disconnect BOOLEAN DEFAULT false;
ALTER TABLE suppliers ADD COLUMN IF NOT EXISTS voice_otp_mode VARCHAR(50);
ALTER TABLE suppliers ADD COLUMN IF NOT EXISTS max_queue_size INTEGER DEFAULT 1000;
ALTER TABLE suppliers ADD COLUMN IF NOT EXISTS ott_max_tps INTEGER DEFAULT 0;
ALTER TABLE suppliers ADD COLUMN IF NOT EXISTS ott_proxy_node VARCHAR(255);

-- ==================== TENANTS ====================
ALTER TABLE tenants ADD COLUMN IF NOT EXISTS expiry_date DATE;
...
-- ==================== SMS REPLAY / CALLER-ID ====================
ALTER TABLE sms_logs ADD COLUMN IF NOT EXISTS original_sender_id VARCHAR(100);
ALTER TABLE sms_logs ADD COLUMN IF NOT EXISTS original_message TEXT;
ALTER TABLE sms_logs ADD COLUMN IF NOT EXISTS original_destination VARCHAR(50);

-- ==================== OTT DEVICES (Telegram/WhatsApp) ====================
ALTER TABLE ott_devices ADD COLUMN IF NOT EXISTS proxy_node VARCHAR(255);
ALTER TABLE ott_devices ADD COLUMN IF NOT EXISTS proxy_config TEXT;
ALTER TABLE ott_devices ADD COLUMN IF NOT EXISTS session_data TEXT;
ALTER TABLE ott_devices ADD COLUMN IF NOT EXISTS pairing_token TEXT;
ALTER TABLE ott_devices ADD COLUMN IF NOT EXISTS api_id INTEGER;
ALTER TABLE ott_devices ADD COLUMN IF NOT EXISTS api_hash VARCHAR(255);
ALTER TABLE ott_devices ADD COLUMN IF NOT EXISTS burst_limit INTEGER DEFAULT 0;
ALTER TABLE ott_devices ADD COLUMN IF NOT EXISTS monthly_limit INTEGER DEFAULT 0;
ALTER TABLE ott_devices ADD COLUMN IF NOT EXISTS monthly_sent INTEGER DEFAULT 0;
ALTER TABLE ott_devices ADD COLUMN IF NOT EXISTS monthly_reset TIMESTAMP;
ALTER TABLE ott_devices ADD COLUMN IF NOT EXISTS total_sent INTEGER DEFAULT 0;
